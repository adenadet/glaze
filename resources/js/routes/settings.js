...
let routes = [
    ...
    {path: '/settings//branches/:id',     component: BranchSingle},
    ...
    {path: '/settings/loan_requirements',     component: LoanRequirements},
    {path: '/settings/loan_types',     component: LoanTypes},
