...
Route::group(['prefix'=>'ums'], function () {
    ...
    Route::get('/bvn_verifications/send_mail/{id}', 'BVNVerificationController@send_mail')->name('ums.bvn_verifications.send_mail');
    Route::post('/bvn_verifications/reject/{id}', 'BVNVerificationController@reject')->name('ums.bvn_verifications.reject');
    Route::get('/bvn_verifications/user/{id}', 'BVNVerificationController@display')->name('ums.bvn_verifications.user');
    ...
    Route::get('/nin_verifications/send_mail/{id}', 'NINVerificationController@send_mail')->name('ums.nin_verifications.send_mail');
    Route::put('/nin_verifications/reject/{id}', 'NINVerificationController@reject')->name('ums.nin_verifications.reject');
    Route::get('/nin_verifications/user/{id}', 'NINVerificationController@display')->name('ums.nin_verifications.user');
    Route::post('/password', 'UserController@password')->name('profile.password');
    Route::post('/profile/employees', 'ProfileController@employees')->name('profile.employees');
