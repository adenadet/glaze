...

{
    ...
    protected $fillable = [
        'user_type', 'nation_id', 'first_name', 'middle_name', 'last_name', 'bvn', 'name', 'unique_id', 'nin', 'image', 'sex', 'street', 'street2', 'city', 'area_id', 'state_id', 'department_id', 'phone', 'alt_phone', 'dob', 'joined_at', 'email', 'personal_email', 'marital_status', 'password', 'remember_token', 'created_at', 'updated_at', 'deleted_by', 'deleted_at'
    ];
